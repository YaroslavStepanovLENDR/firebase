    ...
    <div className="max-w-[420px] mx-auto bg-white min-h-screen">
      <div className="p-5 pb-16">
        ...
        <div className="flex justify-center my-6">
          <img
            src="/lovable-uploads/af611c17-603d-4347-b97d-88f6235c88f2.png"
            alt="X10 Plastic chairs"
        ...
        <div className="mt-6">
          <div className="flex justify-between items-start">
            <h1 className="text-2xl font-semibold text-[rgba(24,23,37,1)]">X10 Plastic chairs</h1>
          ...
          <div className="mt-4">
            ...
            <p className="mt-2 text-[rgba(76,79,77,1)]">
              Set of 10 white plastic chairs for events, parties, or gatherings. Sturdy construction with 
              comfortable design. Can be stacked for easy transport and storage. Perfect for outdoor events.
            </p>
          </div>
          ...
          <div className="mt-8 p-4 bg-[#F6F6F7] rounded-xl">
            ...
            <div className="flex items-center gap-2 mb-4 pl-1">
              ...
              <div className="text-sm text-[#8E9196]">$30 security deposit required</div>
            </div>
          ...
          <div className="mt-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="cursor-pointer hover:text-[rgba(83,177,117,1)] transition-colors">
                ...
                <p className="text-sm text-[rgba(76,79,77,1)]">4.7 ★ (19 reviews)</p>
              </div>
            </div>
          </div>
        </div>
...
export default PlasticChairsDetail;
