    ...
    <div className="max-w-[420px] mx-auto bg-white min-h-screen">
      <div className="p-5 pb-16">
        ...
        <div className="flex justify-center my-6">
          <img
            src="https://cdn.builder.io/api/v1/image/assets/TEMP/ed7a910c47c9e2fdf7a00d3f87d644de0084c3f1d064976269aefd1eda6df762?placeholderIfAbsent=true"
            alt="GoPro Hero6 Black"
        ...
        <div className="mt-6">
          <div className="flex justify-between items-start">
            <h1 className="text-2xl font-semibold text-[rgba(24,23,37,1)]">GoPro Hero6 Black</h1>
          ...
          <div className="mt-4">
            ...
            <p className="mt-2 text-[rgba(76,79,77,1)]">
              GoPro Hero6 Black action camera. 4K video at 60fps, 1080p at 240fps for super slow-motion. 
              Waterproof to 33ft without a housing. Includes 64GB memory card, extra battery and various mounts.
            </p>
          </div>
          ...
          <div className="mt-8 p-4 bg-[#F6F6F7] rounded-xl">
            <div className="flex items-center gap-2 mb-3">
              ...
              <div className="text-2xl font-semibold text-[rgba(24,23,37,1)]">$4.99 <span className="text-sm font-normal text-[#8E9196]">per day</span></div>
            </div>
            
            <div className="flex items-center gap-2 mb-4 pl-1">
              <ShieldCheck className="h-4 w-4 text-[#8E9196]" />
              <div className="text-sm text-[#8E9196]">$50 security deposit required</div>
            </div>
          ...
          <div className="mt-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="cursor-pointer hover:text-[rgba(83,177,117,1)] transition-colors">
                ...
                <p className="text-sm text-[rgba(76,79,77,1)]">4.7 ★ (31 reviews)</p>
              </div>
            </div>
          </div>
        </div>
