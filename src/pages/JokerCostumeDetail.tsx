    ...
    <div className="max-w-[420px] mx-auto bg-white min-h-screen">
      <div className="p-5 pb-16">
        ...
        <div className="flex justify-center my-6">
          <img
            src="https://cdn.builder.io/api/v1/image/assets/TEMP/55d05825f1a583f3fa8301da10dcd8296fabad845620002116e5f6e2598f4c66?placeholderIfAbsent=true"
        ...
        <div className="mt-6">
          <div className="flex justify-between items-start">
            <h1 className="text-2xl font-semibold text-[rgba(24,23,37,1)]">The Joker Costume</h1>
          ...
          <div className="mt-4">
            ...
            <p className="mt-2 text-[rgba(76,79,77,1)]">
              Complete Joker costume set, including purple suit, green wig, makeup kit, and accessories. 
              Perfect for Halloween parties, cosplay events, or themed gatherings. Size: Medium/Large.
            </p>
          </div>
          ...
          <div className="mt-8 p-4 bg-[#F6F6F7] rounded-xl">
            ...
            <div className="flex items-center gap-2 mb-4 pl-1">
              ...
              <div className="text-sm text-[#8E9196]">$20 security deposit required</div>
            </div>
          ...
          <div className="mt-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="cursor-pointer hover:text-[rgba(83,177,117,1)] transition-colors">
                ...
                <p className="text-sm text-[rgba(76,79,77,1)]">4.5 ★ (12 reviews)</p>
              </div>
            </div>
          </div>
        </div>
...
export default JokerCostumeDetail;
