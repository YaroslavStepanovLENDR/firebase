      ...
      <div className="p-5 pb-16">
        ...
        <div className="mt-6">
          <div className="flex justify-between items-start">
            <h1 className="text-2xl font-semibold text-[rgba(24,23,37,1)]">64pcs universal tool set</h1>
          ...
          <div className="mt-4">
            ...
            <p className="mt-2 text-[rgba(76,79,77,1)]">
              Complete 64-piece tool set for all your DIY projects. Includes screwdrivers, 
              wrenches, pliers, socket set, hammer, measuring tape and more. All packed in a 
              durable carry case. Perfect for home repairs and basic maintenance.
            </p>
          </div>
          ...
          <div className="mt-8 p-4 bg-[#F6F6F7] rounded-xl">
            ...
            <div className="flex items-center gap-2 mb-4 pl-1">
              ...
              <div className="text-sm text-[#8E9196]">$25 security deposit required</div>
            </div>
          ...
          <div className="mt-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="cursor-pointer hover:text-[rgba(83,177,117,1)] transition-colors">
                ...
                <p className="text-sm text-[rgba(76,79,77,1)]">4.9 ★ (8 reviews)</p>
              </div>
            </div>
          </div>
        </div>
