      ...
      <div className="p-5 pb-16">
        ...
        <div className="flex justify-center my-6">
          <img
            ...
            className="w-[280px] h-[220px] object-contain"
          />
        </div>

        <div className="mt-6">
          <div className="flex justify-between items-start">
            <h1 className="text-2xl font-semibold text-[rgba(24,23,37,1)]">Foldable pet carrier</h1>
          ...
          <div className="mt-4">
            ...
            <p className="mt-2 text-[rgba(76,79,77,1)]">
              Comfortable foldable pet carrier for small to medium pets. Includes padded bottom, 
              mesh windows for ventilation, and sturdy handles. Perfect for vet visits or travel.
          ...
          <div className="mt-8 p-4 bg-[#F6F6F7] rounded-xl">
            ...
            <div className="flex items-center gap-2 mb-4 pl-1">
              ...
              <div className="text-sm text-[#8E9196]">$15 security deposit required</div>
            </div>
          ...
          <div className="mt-8">
            ...
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 bg-gray-200 rounded-full flex items-center justify-center">
                <span className="text-gray-600 font-medium">KL</span>
              </div>
              <div className="cursor-pointer hover:text-[rgba(83,177,117,1)] transition-colors">
                <p className="font-medium">Kate Lee</p>
                <p className="text-sm text-[rgba(76,79,77,1)]">4.9 ★ (6 reviews)</p>
              </div>
            </div>
          </div>
        </div>
...
export default PetCarrierDetail;
