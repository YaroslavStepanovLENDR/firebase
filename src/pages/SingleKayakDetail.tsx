      ...
      <div className="p-5 pb-16">
        ...
        <div className="mt-6">
          <div className="flex justify-between items-start">
            <h1 className="text-2xl font-semibold text-[rgba(24,23,37,1)]">Single kayak</h1>
          ...
          <div className="mt-4">
            ...
            <p className="mt-2 text-[rgba(76,79,77,1)]">
              Recreational single-person kayak, 10 feet long. Includes paddle, life vest,
              and dry bag. Stable and easy to maneuver, perfect for lakes and calm rivers.
          ...
          <div className="mt-8 p-4 bg-[#F6F6F7] rounded-xl">
            <div className="flex items-center gap-2 mb-3">
              ...
              <div className="text-2xl font-semibold text-[rgba(24,23,37,1)]">$9.99 <span className="text-sm font-normal text-[#8E9196]">per day</span></div>
            </div>
            
            <div className="flex items-center gap-2 mb-4 pl-1">
              <ShieldCheck className="h-4 w-4 text-[#8E9196]" />
              <div className="text-sm text-[#8E9196]">$75 security deposit required</div>
            </div>
          ...
          <div className="mt-8">
            ...
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 bg-gray-200 rounded-full flex items-center justify-center">
                <span className="text-gray-600 font-medium">AW</span>
              </div>
              <div className="cursor-pointer hover:text-[rgba(83,177,117,1)] transition-colors">
                <p className="font-medium">Adam Wilson</p>
                <p className="text-sm text-[rgba(76,79,77,1)]">4.6 ★ (14 reviews)</p>
              </div>
            </div>
          </div>
        </div>
...
export default SingleKayakDetail;
